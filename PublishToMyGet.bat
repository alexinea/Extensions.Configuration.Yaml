...
dotnet pack src/Ref.1.x -c Release -o nuget_pub --no-restore
dotnet pack src/Ref.2.x -c Release -o nuget_pub --no-restore
dotnet pack src/Ref.3.x -c Release -o nuget_pub --no-restore
